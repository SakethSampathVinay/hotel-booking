export const assets = {
  ...
  calenderIcon: 'calenderIcon.svg',
  locationIcon: 'locationIcon.svg',
  starIconFilled: 'starIconFilled.svg',
  arrowIcon: 'arrowIcon.svg',
  starIconOutlined: 'starIconOutlined.svg',
  instagramIcon: 'instagramIcon.svg',
  facebookIcon: 'facebookIcon.svg',
  twitterIcon: 'twitterIcon.svg',
  linkendinIcon: 'linkendinIcon.svg',
  freeWifiIcon: 'freeWifiIcon.svg',
  freeBreakfastIcon: 'freeBreakfastIcon.svg',
  roomServiceIcon: 'roomServiceIcon.svg',
  mountainIcon: 'mountainIcon.svg',
  poolIcon: 'poolIcon.svg',
  homeIcon: 'homeIcon.svg',
  closeIcon: 'closeIcon.svg',
  locationFilledIcon: 'locationFilledIcon.svg',
  heartIcon: 'heartIcon.svg',
  badgeIcon: 'badgeIcon.svg',
  menuIcon: 'menuIcon.svg',
  closeMenu: 'closeMenu.svg',
  guestsIcon: 'guestsIcon.svg',
  addIcon: 'addIcon.svg',
  dashboardIcon: 'dashboardIcon.svg',
  listIcon: 'listIcon.svg',
  uploadArea: 'uploadArea.svg',
  totalBookingIcon: 'totalBookingIcon.svg',
  totalRevenueIcon: 'totalRevenueIcon.svg',
